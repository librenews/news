...
Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: ENV.fetch("APP_DOMAIN", "open.news"), protocol: "https" }
  ...
  config.action_mailer.smtp_settings = {
    ...
    domain:               ENV.fetch("SMTP_DOMAIN", ENV.fetch("APP_DOMAIN", "open.news")),
